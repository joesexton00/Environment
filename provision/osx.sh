...
# Provision OSX Preferences

# Ask for the administrator password upfront
sudo -v

# Keep-alive: update existing `sudo` time stamp until provisioning has finished
...
echo "Provisioning complete, some changes require a logout/restart to take effect."